...
function updateTimer() {
    const targetDate = new Date("february 14, 2026 21:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const recipientNumber1 = '543813499500'; // Número para el primer botón
...
document.getElementById('musicForm').addEventListener('submit', function (event) {
    ...
    const telefono = '543813499500'; // Reemplaza esto con tu número de WhatsApp
